        ...
        <div class="col-lg-12">
            <div class="box">
                            ...
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button onclick="tampilProduk()" class="btn btn-flat" type="button"
                                            style="background-color: #01796f; border-color: #015f57; color: white;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                ...
                                <input type="hidden" name="id_user" id="id_user" value="{{ $userSelected->id }}">
                                ...
                                <div class="form-group row">
                                    <label for="nama_user" class="col-lg-2 control-label">Pengguna</label>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="hidden" name="id_member" id="id_member"
                                                value="{{ $userSelected->id ?? '' }}">
                                            <input type="text" class="form-control" id="nama_user"
                                                value="{{ $userSelected->name ?? '' }}" readonly>
                                            <span class="input-group-btn">
                                                <button onclick="tampilUser()" class="btn btn-flat" type="button"
                                                    style="background-color: #01796f; border-color: #015f57; color: white;">
                                                    <i class="fa fa-arrow-right"></i>
                                                </button>
                                            </span>
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-sm btn-flat pull-right btn-simpan"
                        style="background-color: #01796f; border-color: #015f57; color: white;">
